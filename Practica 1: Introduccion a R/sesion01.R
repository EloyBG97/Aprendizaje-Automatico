...
print("Ejercicio 1.6 crear una secuencia de 1 a 1000 en 4 intervalos")
seq(1, 1000, length.out = 4)

print("Ejercicio 1.7 Cree un vector de 10 componentes enteras decrecientes denominado s. Compruebe \
...
print("Ejercicio 1.10 Con los siguientes números: 7.3, 6.8, 0.005, 9, 12, 2.4, 18.9, .9")
...
print("Ejercicio 1.12 Calcule la media del vector x, usando sum() y length().")
sum(x)/length(x)
...
print("Ejercicio 1.17 Convierta el vector y = c(−10 : 10) en su valor absoluto: y=abs(y) Restricción: \
utilizando los [ ]!!!.")
y <- c(-10 : 10)
y[y < 0] <- y[y < 0] * -1

print("Ejercicio 1.18 Para cada uno de los datasets Auto, Carseats y Hitters, compruebe cuántas mues- \
...
print("Ejercicio 1.20 Rellena la matriz siguiente mm")
m <- matrix(1:16, nrow = 4, ncol = 4)

m[1,]
m[(1:min(d)-1)*min(d) + 1:min(d)]

print("Ejercicio 1.21 Cambie el valor de la esquina superior izda a -1 y los valores de la tercera fila a 1.")
m[1] = -1;
m[3,] <- 1
m

print("Ejercicio 1.22 Comprueba que hace este código")
rr= matrix(rep(1:4,each=2),ncol=2, byrow=T)
mm[rr]

print("Ejercicio 1.23 Asigne el valor -2 a la diagonal principal de la matriz a.")
rr <- matrix(rep(1:4,each), ncol=2, byrow = T)
m[rr] <- -2
m

print("Ejercicio 1.24 Dado una matriz cuadrada inicializada al valor de la fila, se quiere poner a 0 los \
